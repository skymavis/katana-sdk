...
import { USDC } from './tokens/mainnet';
import { RON } from './tokens/ron';
import { USDC_TESTNET } from './tokens/testnet';

// Stablecoin amounts used when calculating spot price for a given currency.
// The amount is large enough to filter low liquidity pairs.
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  [ChainId.mainnet]: CurrencyAmount.fromRawAmount(USDC, 1e10),
  [ChainId.testnet]: CurrencyAmount.fromRawAmount(USDC_TESTNET, 1e10),
};
