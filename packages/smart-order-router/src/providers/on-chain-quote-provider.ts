...
import { ChainId, MIXED_ROUTE_QUOTER_V1_ADDRESSES, QUOTER_ADDRESSES } from '@sky-mavis/katana-core';
...
export class OnChainQuoteProvider implements IOnChainQuoteProvider {
  ...
  constructor({
    ...
    batchParams = DEFAULT_BATCH_PARAMS,
    gasErrorFailureOverride = DEFAULT_GAS_ERROR_FAILURE_OVERRIDES,
    successRateFailureOverrides = DEFAULT_SUCCESS_RATE_FAILURE_OVERRIDES,
    blockNumberConfig = DEFAULT_BLOCK_NUMBER_CONFIGS,
    ...
    quoterAddressOverride?: (useMixedRouteQuoter: boolean) => string | undefined;
    metricsPrefix?: (chainId: ChainId, useMixedRouteQuoter: boolean, optimisticCachedRoutes: boolean) => string;
  }) {
