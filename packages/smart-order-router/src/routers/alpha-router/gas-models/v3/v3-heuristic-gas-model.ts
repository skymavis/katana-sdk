...
export class V3HeuristicGasModelFactory extends IOnChainGasModelFactory {
  public async buildGasModel({
    ...
    const calculateL1GasFees = async (): Promise<{
      ...
      return await calculateL1GasFeesHelper(chainId, usdPool, quoteToken, pools.nativeAndQuoteTokenV3Pool);
    };
  ...
  private estimateGas(
    ...
    const baseGasUse = BASE_SWAP_COST.add(hopsGasUse)
      .add(tokenOverhead)
      .add(tickGasUse)
